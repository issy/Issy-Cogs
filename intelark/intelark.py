...
# Helper functions
    ...
    def make_ark_embed(self, data: dict, index: dict = {}) -> discord.Embed:
        ...
        core_thread_value = f"{data['CoreCount']} / {data['CoreCount']}" if data['HyperThreading'] == 'No' or data['HyperThreading'] == None else f"{data['CoreCount']} / {data['ThreadCount']}"
